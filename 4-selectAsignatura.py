...
if connection:
    ...
    query = "SELECT idAsignatura, nombre, cuatrimestre, creditos, caracter FROM asignatura WHERE caracter = 'optativa' and cuatrimestre = 1 order by idAsignatura"
    ...
    if df is not None:
        # Exportar el DataFrame a un archivo Excel
        export_dataframe_to_excel(df, "asignaturaSelect_data.xlsx")
