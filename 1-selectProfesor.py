...
if connection:
    ...
    query = "SELECT idProfesor, concat(apellido1, ' ', apellido2, ' ', nombre) as nombre, email FROM profesor order by apellido1, apellido2"
    ...
    if df is not None:
        # Exportar el DataFrame a un archivo Excel
        export_dataframe_to_excel(df, "profesorOrder_data.xlsx")
